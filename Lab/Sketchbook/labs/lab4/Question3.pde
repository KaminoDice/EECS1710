...
String dictionary = "abstract application benchmark compiler domain encryption hashmap matrix notion ryzen silicon facebook google laser obsidian puzzle quadratic ultrasound virtual oxygen";
//   String to contain 20 words (space separated);
//   array to keep dictionary of words;
int[] hidex;
//   array to track hidden word;
int[] showIndex;
